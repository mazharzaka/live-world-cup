async function testEndpoints() {
  ...
  try {
    const arabicRes = await fetch("http://https://live-world-cup.onrender.com/api/movies/arabic");
    ...
    const englishRes = await fetch("http://https://live-world-cup.onrender.com/api/movies/english");
