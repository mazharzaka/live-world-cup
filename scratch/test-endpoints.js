async function testEndpoints() {
  ...
  try {
    const arabicRes = await fetch("https://smfxhlj1-3001.euw.devtunnels.ms/api/movies/arabic");
    ...
    const englishRes = await fetch("https://smfxhlj1-3001.euw.devtunnels.ms/api/movies/english");
